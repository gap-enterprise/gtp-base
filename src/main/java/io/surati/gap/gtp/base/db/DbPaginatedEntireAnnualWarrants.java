...
public final class DbPaginatedEntireAnnualWarrants implements AnnualWarrants {
     ...
     * @param year Year
     */
    public DbPaginatedEntireAnnualWarrants(
    ...
    private Condition condition() {
        ...
        result = result.and(
            ...
            GtpAnnualWarrantView.GTP_ANNUAL_WARRANT_VIEW.IS_SPLIT.eq(false)
        ).and(
